...
// Creation of strings is possible in three ways, we can create a string using double-quotes(""), single-quotes('') and template literals or backticks(``), another is string new objects.
let string1 = "prince";
console.log(string1);
